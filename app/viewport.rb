class Viewport
  attr_accessor :x, :y, :w, :h, :display_w, :display_h, :max_pos_x, :max_pos_y, :game_map, :center_x, :center_y
  ...
  def render(args)
    args.outputs.primitives << {x: 0, y: 0, w: self.display_w, h: self.display_h,
                                path: :game_map,
